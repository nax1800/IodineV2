...
FQuat World::FRotToQuat(FRotator Rot)
{
...
FActorSpawnParameters World::CreateSpawnParams(ESpawnActorCollisionHandlingMethod SpawnCollisionHandlingOverride, bool bDeferConstruction, AActor* Owner)
{
...
ENetMode World::hk_GetNetMode(UWorld* World) { return ENetMode::NM_DedicatedServer; }
