...
{
public:
	TDelegate<void(const struct FUniqueNetIdRepl& UniqueId, EFortPartyMemberLocation Location)> K2Node_CreateDelegate_OutputDelegate; // 0x0000(0x0010)(ZeroConstructor, NoDestructor)
	...
	TDelegate<void(const struct FUniqueNetIdRepl& UniqueId, bool bReady)> K2Node_CreateDelegate_OutputDelegate1234; // 0x0060(0x0010)(ZeroConstructor, NoDestructor)
