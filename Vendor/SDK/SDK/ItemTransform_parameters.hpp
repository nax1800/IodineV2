...
public:
	...
	TDelegate<void(const TArray<struct FFortItemInstanceQuantityPair>& TransmoggedItems, const TArray<struct FFortItemInstanceQuantityPair>& RecycledItems)> K2Node_CreateDelegate_OutputDelegate123; // 0x0070(0x0010)(ZeroConstructor, NoDestructor)
