...
{	
	...
	namespace FMemory
	{
		static inline void (*Free)(void* Array) = decltype(Free)(__int64(GetModuleHandle(0)) + 0x12731D0);
		static inline void* (*Realloc)(void*, __int64, unsigned int) = decltype(Realloc)(__int64(GetModuleHandle(0)) + 0x1280550);
	}
